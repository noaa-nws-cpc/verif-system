...
//         					require("datesValid_dateRange.php");
						...
						<li data-setting=\"regions\" class=\"setting\">
							<span class=\"settingLabel\">Region(s) [<span data-label=\"Region(s)\" data-tooltip=\"This field will be filled in when you select regions on the map. You can also list regions separated by commas, enter 'CONUS' (without quotes) to verify the CONUS, or enter 'All' (without quotes) to verify all regions.\"> ? </span>]</span>
							<div>
